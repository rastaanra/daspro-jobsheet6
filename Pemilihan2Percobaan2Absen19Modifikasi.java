...
public class Pemilihan2Percobaan2Absen19Modifikasi {
    public static void main(String[] args) {
        ...
        System.out.println("Masukkan jenis pembayaran(cash/QRIS) = ");
        String pembayaran = absen19.next();
        ...
        if (pembayaran.equalsIgnoreCase("QRIS")) {
            ...
            double potongan = totalBayar - 1000;
